// H1: Pæn, selvstændig HTML-rapport til "Download mine data".
// Klienten henter den som en fil, brugeren selv kan gemme, genåbne og
// printe til PDF. JSON-varianten bevares som maskinlæsbar mulighed (?format=json).
