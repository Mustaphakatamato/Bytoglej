...
const DEFAULT_DISTANCE_KM     = 25;    // gennemsnitlig kommuneradius hvis adresse mangler
 ...
 */
export function calculateCO2Savings({ categoryId, distanceKm }) {
  ...
  const routedDistance    = rawDistance * ROUTE_BUFFER; // tur fra A → B
