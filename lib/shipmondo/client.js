...
export async function createShipment({ sender, receiver, carrier, service_type, size_category, reference, pickup_point_id }) {
  ...
  console.log('[shipmondo] keys:', Object.keys(data));
  console.log('[shipmondo] tracking_number:', data.tracking_number);
  console.log('[shipmondo] tracking_link:', data.tracking_link);
  console.log('[shipmondo] pkg_no:', data.pkg_no);
  console.log('[shipmondo] labels:', JSON.stringify(data.labels));
  console.log('[shipmondo] packages:', JSON.stringify(data.packages));
  console.log('[shipmondo] shipment_labels:', JSON.stringify(data.shipment_labels));
  return {
