...
// Estimat-tabel. Den autoritative pris hentes altid live via Shipmondo (live-quote /
// create-intent); disse tal er kun til visning + fallback. Alle tre carriers (PostNord,
// GLS, DAO) indgår i "billigste"-beregningen — den faktisk billigste afgøres af live-priser.
export const RATES = {
  pdk_parcel_shop: {
  ...
  dao_parcel_shop: {
    label: 'DAO pakkeshop',
    carrier_code: 'dao', product_code: 'DAO_STS', type: 'parcel_shop',  // daoSHOP (kræver service_point)
    prices: { small: 48.00, medium: 56.00, large: 81.00, xlarge: 110.00 },
  },
  dao_home: {
