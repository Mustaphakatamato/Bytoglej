// Nav-level grouping — purely for display in the category strip.
// Each group maps to one or more CATEGORIES keys.
// Clicking a single-item group navigates directly; multi-item groups open a hover dropdown.
export const NAV_CATEGORY_GROUPS = [
  {
    key: 'legetoj', label: 'Legetøj', emoji: '🧸',
    items: [
      { key: 'plush-small',         label: 'Bamser & plysdyr (lille)' },
      { key: 'plush-large',         label: 'Bamser & plysdyr (stor)' },
      { key: 'plastic-toys-small',  label: 'Plastiklegetøj (lille)' },
      { key: 'plastic-toys-medium', label: 'Plastiklegetøj (medium)' },
      { key: 'plastic-toys-large',  label: 'Plastiklegetøj (stor)' },
      { key: 'construction-toys',   label: 'Konstruktionslegetøj' },
      { key: 'electronic-toys',     label: 'Elektronisk legetøj' },
      { key: 'costumes-roleplay',   label: 'Kostumer & rollespil' },
    ],
  },
  {
    key: 'traelegetoj', label: 'Trælegetøj', emoji: '🪵',
    items: [{ key: 'wooden-toys', label: 'Trælegetøj & klodser' }],
  },
  {
    key: 'boeger-spil', label: 'Bøger & spil', emoji: '📚',
    items: [
      { key: 'books',       label: 'Bøger' },
      { key: 'puzzles',     label: 'Puslespil' },
      { key: 'board-games', label: 'Brætspil' },
    ],
  },
  {
    key: 'udendoers', label: 'Udendørs', emoji: '🌳',
    items: [
      { key: 'outdoor-toys',     label: 'Udelegetøj' },
      { key: 'ride-on-toys',     label: 'Cykler, løbehjul & lign.' },
      { key: 'sports-equipment', label: 'Sportsudstyr' },
    ],
  },
  {
    key: 'kreativt', label: 'Kreativt', emoji: '🎨',
    items: [
      { key: 'art-craft-supplies',  label: 'Kreativt & hobby' },
      { key: 'musical-instruments', label: 'Musikinstrumenter' },
    ],
  },
  {
    key: 'baby-mobler', label: 'Baby & møbler', emoji: '👶',
    items: [
      { key: 'baby-equipment',     label: 'Babyudstyr' },
      { key: 'children-furniture', label: 'Børnemøbler' },
    ],
  },
  {
    key: 'andet', label: 'Andet', emoji: '📦',
    items: [{ key: 'other', label: 'Andet legetøj' }],
  },
];
