                    ...
                    <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:8 }}>
                      {imgPreviews.map((src,i) => (
                        <div
                          ...
                          style={{ position:'relative', aspectRatio:'1', borderRadius:12, overflow:'hidden', border: overIdx===i ? `2px solid ${PRIMARY}` : i===0 ? `2px solid ${PRIMARY}` : '2px solid transparent', opacity: draggingIdx===i ? 0.9 : 1, transform: draggingIdx===i ? 'scale(1.07)' : 'scale(1)', boxShadow: draggingIdx===i ? '0 8px 24px rgba(22,34,28,0.22)' : 'none', cursor:'grab', transition:'transform 0.15s ease, box-shadow 0.15s ease, opacity 0.15s, border-color 0.15s', userSelect:'none', WebkitUserSelect:'none', WebkitTouchCallout:'none', touchAction:'none', zIndex: draggingIdx===i ? 2 : 1 }}>
